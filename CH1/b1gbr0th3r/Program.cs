            ...
            class Program
            {
                static void Main(string[] args)
                {
                    ...
                    while (playAgain)
                    {
                        ...
                        while (scorePlayer < 3 && scoreCPU < 3)
                        {
                            ...
                            switch (randomInt)
                            {
                                ...
                                case 3:
                                    ...
                                    {
                                        Console.WriteLine("...trojan virus bypassed security wall successfully, payload was deployed and has infected b1gbr0th3rs mother board...\n\n");
                                        scorePlayer++;
                                    }
                                    else if (inputPlayer == "surge")
                                    {
                        ...
                        if (scorePlayer == 3)
                        {
                            Console.WriteLine("\n\n...crisis averted, man reigns supreme...\n\n");
                        }
                        else if (scoreCPU == 3)
                        {
                            Console.WriteLine("\n\n...b1gbr0th3r: it seems man was nothing but the reproductive organs of the machine world...\n\n");
                        }
                        else
                        {
